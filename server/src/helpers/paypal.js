...
try {
  paypal.configure({
    mode: env.PAYPAL_MODE || "sandbox", // "sandbox" or "live": Default to sandbox if not set
    client_id: env.PAYPAL_CLIENT_ID, // Set this in .env
    client_secret: env.PAYPAL_CLIENT_SECRET, // Set this in .env
  });
